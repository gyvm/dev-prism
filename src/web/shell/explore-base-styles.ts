...
// Base and chart styles used by Explore. The former version lived in the
// Shared Explore shell stylesheet; Explore owns this vocabulary directly.
export const EXPLORE_BASE_STYLES = `${renderRootCss()}
