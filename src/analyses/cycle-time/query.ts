...
// SQL-native cycle-time funnel (1-2) and lead-time trend (1-3). Both share the
// same four stage definitions from stage-sql.ts, so Explore (WASM) and Reports
// (native) compute identical numbers — parity by shared module (design D4).
//
