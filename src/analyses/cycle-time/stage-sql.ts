...
// Shared SQL fragments for the cycle-time funnel (1-2) and lead-time trend (1-3),
// so both run the identical stage definitions — parity by shared module (design D4).
//
