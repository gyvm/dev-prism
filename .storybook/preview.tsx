...
import { EXPLORE_BASE_STYLES } from "../src/web/shell/explore-base-styles.js";
...
// .metric-card, …) from EXPLORE_BASE_STYLES' :root block — without it every var()
// falls back to black.
const sheet = document.createElement("style");
sheet.textContent = `${EXPLORE_BASE_STYLES}\n${EXPLORE_STYLES}`;
document.head.appendChild(sheet);

// EXPLORE_BASE_STYLES scopes page chrome to body/main; Explore views render inside
