...
| Action | 種類 | 役割 |
|---|---|---|
| `your-org/dev-prism@v1` | Docker コンテナ | PR 収集 → `data/dwh` (parquet) を増分更新 |
| `your-org/dev-prism/site@v1` | composite | `data/dwh` から Explore + Reports サイトを `dist/` にビルド |
...
> `image: 'docker://ghcr.io/your-org/dev-prism:1'` に切り替えると、consumer 側の毎 run の
